...
public class PolicyHandler {
    ...
    public void wheneverReservationCreated_UpdateRoomStatus(
        @Payload ReservationCreated reservationCreated
    ) {
        ReservationCreated event = reservationCreated;
        System.out.println(
            "\n\n##### listener UpdateRoomStatus : " +
            reservationCreated +
            "\n\n"
        );

        // Sample Logic //
        MeetingRoom.updateRoomStatus(event);
    }
    ...
    public void wheneverReservationCancelled_UpdateRoomStatus(
